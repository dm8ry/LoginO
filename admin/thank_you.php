	...
	<div class="container">	
		<div class="row">		
			...
			<div class="col-sm-6 central-container">
				...
				<div class="login"><span style="color: red; font-style: normal;">Login</span><span style="color: white">O</span> | <span class="sub-title-container">Thank You!</span></div>
				<br/>
